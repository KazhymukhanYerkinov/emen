  ...
  return (
    <div className='my-profile'>
      ...
      <div className='my-profile__content'>
        { props.auth_data.subscription 
        ? <Subs BASE_URL = { props.BASE_URL } subscription = { props.auth_data.subscription }/>
        : <div></div> }
...
const Subs = (props) => {
  ...
  let { subscription_logo, subscription_name, 
    ...
    num_of_topic_exams, subscription_end_time } = props.subscription;
