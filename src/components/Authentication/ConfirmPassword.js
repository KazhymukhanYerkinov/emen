    ...
    return (
        <form onSubmit = { handleSubmit }>
            <div className = 'auth__input'>
                ...
                <button className = 'button button__submit' type = 'submit'> {showFetchButton ? <img className = 'auth__loader' src = { loader } alt = '' />: <span>Создать</span>} </button>    
            </div>
        </form>
    )
}
            ...
            <div className = 'container'>
                <div className = 'auth__inner'>
                    ...
                    <div className = 'auth__image'>
                        <img  className = 'image image__80' src = { confirm } alt = ''/>
                    </div>

                    <div className = 'auth__content'>
                        <div className = 'title'> Восстановление пароля </div>
                        <div className = 'auth__step'> 1. Cоздать новый пароль </div>
